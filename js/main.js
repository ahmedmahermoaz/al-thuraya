...
$(document).ready(function () {
    ...
    $(".prod-tab-cont").on("click", ".prod-tab-mob", function () {
        ...
        // main
        $(".prod-tabs li a[data-prodtab-num=" + $(this).data("prodtab-num") + "]")
            .parents(".prod-tabs")
            .find("li a")
            .removeClass("active");
        $(
    ...
    $(".fr-pop-tabs li").on("click", "a", function () {
        ...
        // mobile
        $(".fr-pop-tab-mob[data-frpoptab-num=" + $(this).data("frpoptab-num") + "]")
    ...
    if ($(".fr-pop-tabs").length > 0) {
        ...
        $(window).resize(function () {
            ...
            if ($(window).width() > 751) {
                ...
                menu_sections
                    .find("li.fr-pop-tabs-other")
                    .insertBefore(".fr-pop-tabs-more");
                menu_sections
                    .find("li.fr-pop-tabs-other")
                    .removeClass("fr-pop-tabs-other");
            }
        });
    }
...
$(window).load(function () {
    ...
    if ($(".prod-slider-car").length > 0) {
        $(".prod-slider-car").each(function () {
            $(this).bxSlider({
                pagerCustom: $(this)
                    .parents(".prod-slider-wrap")
                    .find(".prod-thumbs-car"),
                adaptiveHeight: true,
                infiniteLoop: false,
            });
...
function fixed_on_scroll() {
    ...
    var wh = $(window).height() || 0,
        ...
        thumbsPos =
            typeof thumbs.offset() !== "undefined" ? thumbs.offset().top : 0,
    ...
    if (
        (st - delta < contentPT && !(smallEnough && contentPos < headH)) ||
        tooBig
    ) {
        thumbs.removeAttr("style");
        thumbs.removeClass("stick");
    } else if (
        wh + st >= Math.max(contentPos + contentH, sliderPos + sliderH) &&
        thumbsPos > sliderPos
    ) {
    ...
    if (
        ...
        st + delta > Math.max(lastSt, contentPos + contentH - wh) &&
        contentBottom < 0
    ) {
        styles = {
            bottom: 0,
        ...
        styles = {
            marginTop:
                contentBottom >= 0
                    ? sliderH - contentH
                    : Math.min(contentPos - sliderPos, sliderH - contentH + contentPT),
        };
    }
...
$(window).load(function () {
    ...
    if ($(".prod2-thumbs-car li a").length > 0) {
        ...
        $(".prod2-thumbs-car li").on("click", "a", function () {
            if ($(window).width() >= 975) {
                var el_index = $(this).attr("data-slide-index"),
    ...
    if ($(".prod2-slider-car").length > 0) {
        $(".prod2-slider-car").each(function () {
            ...
            var this_thumbs = $(this)
                .parents(".prod2-slider-wrap")
                .find(".prod2-thumbs-car");
